  ...
  return (
    <Box>
      <AppBar position="static" color="transparent" elevation={0} sx={{
        ...
        <Toolbar>
          <Typography variant="h6" sx={{ flexGrow: 1, fontWeight: 700 }}>Aqua Thistle</Typography>
          {pathname != "/dashboard" ? <Typography component={Link} to="/dashboard" sx={{ mr: 2, textDecoration: 'none' }}>Dashboard</Typography> : null}
